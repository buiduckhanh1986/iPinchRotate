...
@interface Case06 ()<UIGestureRecognizerDelegate>

@end

@implementation Case06
{
...
- (void) caseDescription{
    ...
    lblCase.text = @"Rotation shouldBeRequiredToFailByGestureRecognizer Pinch";
    ...
    lblNote02.text = @"+ True: Rotation nên fail khi nhận Pinch -> chỉ nhận Rotation vì Rotation bao giờ cũng nhận diện được";
    ...
    lblNote03.text = @"+ False: vế else trả về true Pinch nên fail khi nhận Rotation -> chỉ nhận Pinch vì Pinch bao giờ cũng nhận diện được";
